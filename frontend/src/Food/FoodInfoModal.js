...
class FoodInfoModal extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount(e){
        console.log("FoodModal component mounting");
                ...
                <ModalBody>
                    <div className="row mt-sm-2 ml-sm-2">
                        ...
                        <div className="col-sm-7">
                            ...
                            <label className="display-5 mb-sm-3 ml-4 blockquote-header" htmlFor="restaurant_info">Khala Bhuna</label>
                            <br />
